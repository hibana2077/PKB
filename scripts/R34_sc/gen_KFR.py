...
def main():
    # Generate KFRxxx scripts in deterministic order
    os.makedirs(THIS_DIR, exist_ok=True)
    submit_lines = ["#!/bin/bash", "set -e", "# Submit all KFR jobs in order"]
    idx = 1
    ...
    table_path = os.path.join(THIS_DIR, "KFR_table.md")
    ...
    submit_path = os.path.join(THIS_DIR, "KFR_submit_all.sh")
